    ...
    <div>
      ...
      <div className='w-[1609px] h-[632.89px] mt-[174px] ml-[179px]'>
        <div className='w-[1100px] h-[547.89px] bg-[#ffffff]'>
          <Image src="/image/Auto.svg" alt="Auto" width={1100} height={547.89} />
          <Image src="/image/Layout.svg" alt="Layout" width={1100} height={547.89} />
        </div>
      </div>

      <div className='flex w-[350.67px] h-[295px] mt-[28px] ml-[1100px]'>
        <Image src="/image/Frame.svg" alt="Frame" width={350.67} height={295} />
      </div>
